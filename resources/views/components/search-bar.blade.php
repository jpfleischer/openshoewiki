  ...
  <div class="card-body pb-0 pt-3">
    <div class="row">
      <div class="col-md-8 col-lg-9 col-xl-10 mb-3">
        ...
        <input autocomplete="off" id="search" class="form-control input-lg" type="text" name="search" placeholder="{{ __('ui.search.placeholder') }}" value="{{request('search')}}" role="search">
      </div>
