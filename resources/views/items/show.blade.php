    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-sm p-2">
                ...
                <div class="row p-0 mx-0 my-3">
                    <div class="col p-1 list-group text-center small">
                    <a class="btn btn-outline-primary" href="{{ url('/admin/items') }}">
            ...
            <div class="col-sm p-2 px-4">
                ...
                <div class="text-muted">
                    ...
                    <p class="m-0">
                        ...
                        @elseif ($item->pending())
                            <span class="text-warning">{{ __('ui.item.pending') }}</span>
                        @elseif ($item->changesRequired())
                            <span class="text-danger">{{ __('ui.item.changes_requested') }}</span>
                        @else
