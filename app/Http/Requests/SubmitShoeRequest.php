...
class SubmitShoeRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'source_page_archive_id' => ['nullable', 'string', 'uuid', 'exists:source_page_archives,id'],
            'source_page_url' => ['nullable', 'url', 'max:2000'],
            'source_page_title' => ['nullable', 'string', 'max:1000'],
            'source_page_html' => ['nullable', 'string', 'max:5242880'],
            'source_page_captured_at' => ['nullable', 'date'],
